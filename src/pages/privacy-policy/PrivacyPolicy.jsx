...
const PrivacyPolicy = () => {
  return (
    <div className="tandcWrapper">
      <div className="terms">
        <h1>Privacy Policy for Mictokk App</h1>
        <p>
          At mictokk.com, accessible from www.mictokk.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by mictokk.com and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in mictokk.com. This
        ...
        <h2>Log Files</h2>
        <p>
          mictokk.com follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertisements and links that appear on mictokk.com, which are sent
          directly to users' browser. They automatically receive your IP address
          when this occurs. These technologies are used to measure the
          effectiveness of their advertising campaigns and/or to personalize the
          advertising content that you see on websites that you visit. Note that
          mictokk.com has no access to or control over these cookies that are
        ...
        <br />
        <p>
          mictokk.com's Privacy Policy does not apply to other advertisers or
          ...
          be found at the browsers' respective websites. We may consider and
        ...
        <p>
          ...
          mictokk.com does not knowingly collect any Personal Identifiable
